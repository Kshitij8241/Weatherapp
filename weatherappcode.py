...
api_key = 'a87495e93eaf002331038fc91574ab86'
api_call = 'https://api.openweathermap.org/data/2.5/forecast?appid=' + api_key

running = True

print('Welcome to Kshitij\'s 5 day weather forecast application using OpenWeatherMap\'s API!')
...
while running:
    ...
    while True:
        ...
        if running.lower() == 'yes' or running.lower() == 'y':
            ...
            print('Thank you for using Kshitij\'s 5 day weather forecast application.')
